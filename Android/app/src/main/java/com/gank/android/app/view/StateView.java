...
public class StateView extends View {
    ...
    private int mEmptyClickResource;
    private int mRetryResource;
    private int mRetryClickResource;
    private int mLoadingResource;
    private int mLoadingClickResource;
    ...
    private boolean mIsRetryWithLoading = true;

    private LayoutInflater mInflater;
    private OnRetryClickListener mRetryClickListener;
    private OnLoadingClickListener mLoadingClickListener;
    ...
    private void setVisibility(View view, int visibility){
        if (view != null) {
            ...
            if (visibility == VISIBLE) {
                Kits.UI.fadeIn(view,500);
            }else {
                Kits.UI.fadeOut(view,500);
            }
    ...
    public View showEmpty(){
        if (mEmptyView == null) {
            ...
            final View clickView = mEmptyView.findViewById(mEmptyClickResource);
            if (clickView != null) {
    ...
    public View showRetry(){
        if (mRetryView == null) {
            ...
            final View clickView = mRetryView.findViewById(mRetryClickResource);
            if (clickView != null) {
                clickView.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mRetryClickListener != null){
                            if (mIsRetryWithLoading) {
                                showLoading();
                            }
    ...
    public View showLoading(){
        if (mLoadingView == null) {
            ...
            mProgressView = (ImageView) mLoadingView.findViewById(R.id.progress_wheel);
            mProgressDrawable = new ProgressDrawable();
            mProgressDrawable.setColor(0xFF6225);
            ...
            final View clickView = mLoadingView.findViewById(mLoadingClickResource);
            if (clickView != null) {
                clickView.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mLoadingClickListener != null){
                            mLoadingClickListener.onLoadingClick();
                        }
                    }
                });
            }
    ...
    public void setOnRetryClickListener(int id,OnRetryClickListener listener){
        this.mRetryClickListener = listener;
        this.mRetryClickResource = id;
    }

    public void setOnRetryClickListener(int id,boolean isRetryWithLoading,OnRetryClickListener listener){
        this.mIsRetryWithLoading = isRetryWithLoading;
        this.mRetryClickListener = listener;
        this.mRetryClickResource = id;
    }
     ...
     * @param listener {@link OnRetryClickListener}
     */
    public void setLoadingClickListener(int id,OnLoadingClickListener listener){
        this.mLoadingClickListener = listener;
        this.mLoadingClickResource = id;
    }
     ...
     * @param listener {@link OnRetryClickListener}
     */
    public void setOnEmptyClickListener(int id ,OnEmptyClickListener listener){
        this.mEmptyClickListener = listener;
        this.mEmptyClickResource = id;
    }
