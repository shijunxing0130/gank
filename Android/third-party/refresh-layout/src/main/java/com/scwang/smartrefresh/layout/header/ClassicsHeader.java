...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    public void setRefreshHeaderListener(RefreshHeaderListener refreshHeaderListener) {
        mRefreshHeaderListener = refreshHeaderListener;
    }
    ...
    public void onPullingDown(float percent, int offset, int headHeight, int extendHeight) {
        if (mRefreshHeaderListener != null) {
            mRefreshHeaderListener.onPullingDown(percent,offset,headHeight,extendHeight);
        }
    }
    ...
    public void onReleasing(float percent, int offset, int headHeight, int extendHeight) {
        if (mRefreshHeaderListener != null) {
            mRefreshHeaderListener.onReleasing(percent,offset,headHeight,extendHeight);
        }
    }
...
//    }
    ...
    public ClassicsHeader setTitleMarginTop(int dp) {
        MarginLayoutParams lp = (MarginLayoutParams)mTitleText.getLayoutParams();
